...
```python
#__SOLUTION__
z_score = (8636 - 9000)/(900/np.sqrt(40))
z_score
```
...
```python
#__SOLUTION__
# Null: Customers with a coupon spend the same amount as customers without a coupon
# Alt: Customers with a coupon spend more than customer without a coupon
```
...
```python
#__SOLUTION__
# Null: Customers with ad1 and ad2 spent the same amount
# Alternative: Customers with ad1 and ad2 spent different amounts
```
...
```python
#__SOLUTION__
# Two sample independent, two tail t-test
```
